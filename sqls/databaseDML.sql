...
VALUES ('advisor', 'test', 'Jennifer', 'Pope', 'jennifer_pope@northeastern.edu', '1111111111', 'advisor', 'Computer Science', NULL, 'Silicon Valley', 'Khoury College', NULL, NULL, NULL, NULL, 'Mon 9-10 PT AM');
-- INSERT INTO Users(user_name, user_password, first_name, last_name, email, mobile, role_type, department, advisor, campus, college, required_credits, accquired_credits, time_ticket_from, time_ticket_to, office_hour)
...
-- Student
INSERT INTO Users(user_name, user_password, first_name, last_name, email, mobile, role_type, major, department, advisor, campus, college, required_credits, accquired_credits, time_ticket_from, time_ticket_to, office_hour)
VALUES ('student', 'test', 'Crystal', 'Lee', 'crystal_lee@northeastern.edu', '3333333333', 'student', 'Marketing','Entrepreneurship', 1, 'Boston', 'School of Technological Entrepreneurship', 36, 20, '2022-11-20 14:45:00', '2022-12-30 14:45:00', NULL);
-- INSERT INTO Users(user_name, user_password, first_name, last_name, email, mobile, role_type, department, advisor, campus, college, required_credits, accquired_credits, time_ticket_from, time_ticket_to, office_hour)
...
-- Admin
INSERT INTO Users(user_name, user_password, first_name, last_name, email, mobile, role_type, department, advisor, campus, college, required_credits, accquired_credits, time_ticket_from, time_ticket_to, office_hour)
VALUES ('admin', 'test', 'AdminFirstName', 'AdminLastName', 'admin@northeastern.edu', '5555555555', 'admin', 'Administration', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
-- INSERT INTO Users(user_name, user_password, first_name, last_name, email, mobile, role_type, department, advisor, campus, college, required_credits, accquired_credits, time_ticket_from, time_ticket_to, office_hour)
...
INSERT INTO StudentRegisteredCourses(student_id, CRN, date) VALUES (2, 112, '2022-12-06 12:00:00');
-- INSERT INTO StudentRegisteredCourses(student_id, CRN, date) VALUES (2, 112, '2022-12-06 12:00:00');

-- StudentWaitlistedCourses
INSERT INTO StudentWaitlistedCourses(student_id, CRN, date) VALUES (2, 113, '2022-12-06 12:00:00');
-- INSERT INTO StudentWaitlistedCourses(student_id, CRN, date) VALUES (2, 113, '2022-12-06 12:00:00');
...
VALUES (112, 'CS 5200', 'Database Management', 4, 'Professor Lee', 'This is a very good course.', 'CS 5001', '102', 'B', 'Silicon Valley', 'Computer Science', 'Khoury College', 'Fall 2023', 'Tuesday', 60, 20, '1', '20221105');
INSERT INTO Courses (CRN, course_id, course_name, credits, professor, course_description, prerequisites, classroom, building, campus, department, college, term, schedule, course_capacity, waitlist_capacity, posted_by, created_by)
VALUES (113, 'CS 5610', 'Web Development', 4, 'Professor Good', 'This is a very good course.', 'CS 5004', '103', 'A', 'Seattle', 'Computer Science', 'Khoury College', 'Fall 2023', 'Monday', 0, 20, '1', '20221108');
INSERT INTO Courses (CRN, course_id, course_name, credits, professor, course_description, prerequisites, classroom, building, campus, department, college, term, schedule, course_capacity, waitlist_capacity, posted_by, created_by)
VALUES (114, 'CS 7295', 'Data Visualization', 4, 'Professor Despot', 'This is a very hard course.', 'CS 5610', '1001', 'B', 'Silicon Valley', 'Computer Science', 'Khoury College', 'Fall 2023', 'Wednesday', 40, 30, '1', '20221205');
INSERT INTO Courses (CRN, course_id, course_name, credits, professor, course_description, prerequisites, classroom, building, campus, department, college, term, schedule, course_capacity, waitlist_capacity, posted_by, created_by)
VALUES (115, 'CS 5800', 'Algorithms', 4, 'Professor FullMark', 'This is a very easy course.', 'CS 5010', '901', 'C', 'Seattle', 'Computer Science', 'Khoury College', 'Fall 2023', 'Friday', 0, 20, '1', '20221204');
