...
INSERT INTO StudentRegisteredCourses(student_id, CRN) VALUES (199712119, 100000002);

-- StudentWaitlistedCourses
INSERT INTO StudentWaitlistedCourses(student_id, CRN) VALUES (197121110, 234567899);
INSERT INTO StudentWaitlistedCourses(student_id, CRN) VALUES (199712119, 414546185);
...
-- Courses
INSERT INTO Courses (CRN, course_id, course_name, credits, professor, course_description, prerequisites, classroom, building, campus, department, college, term, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted, posted_by, created_by) VALUES (112, 'CS 5200', 'Database Management', 4, 'Professor Marvelous', 'This is a very good course.', 'CS 1000', '102', 'B', 'Silicon Valley', 'Computer Science', 'Khoury College', 'Fall 2023', 60, 20, 30, 1, '2', '20221105');
INSERT INTO Courses (CRN, course_id, course_name, credits, professor, course_description, prerequisites, classroom, building, campus, department, college, term, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted, posted_by, created_by) VALUES (113, 'CS 5610', 'Web Development', 4, 'Professor Evil', 'This is a very good course.', 'CS 1000', '103', 'B', 'Silicon Valley', 'Computer Science', 'Khoury College', 'Fall 2023', 60, 20, 50, 10, '2', '20221108');

-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(100000003, 'LAW 101', 'Intro to American Law', 4, 'This course will give you a glimpse into six different areas of American law: Tort Law, Contract Law, Property, Constitutional Law, Criminal Law, and Civil Procedure. You will gain insight into the complexities and dilemmas that arise from the application of law in different settings, and what is distinctive about American approaches.', 'School of Law', 'Law', 'Spring 2023', 40, 40, 0, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(100000004, 'LAW 201', 'Introduction to International Criminal Law', 4, 'From the Nuremberg trial to the case against Saddam Hussein, from the prosecution of Al-Qaeda terrorists to the trial of Somali pirates – no area of law is as important to world peace and security as international criminal law.  Taught by one of the world’s leading experts in the field, this course will educate students about the fundamentals of international criminal law and policy.  We will explore the contours of international crimes such as genocide, war crimes, terrorism, and piracy.  We will examine unique modes of international criminal liability and specialized defenses.  And we will delve into the challenges of obtaining custody of the accused and maintaining control of the courtroom.', 'School of Law', 'Law', 'Spring 2023', 30, 30, 0, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(234567890, 'AP 101', 'Social Psychology', 4, 'The branch of psychology that deals with social interactions, including their origins and their effects on the individual.', 'Bouvé College of Health Sciences', 'Department of Applied Psychology', 'Spring 2022',100, 20, 0, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(234567899, 'JN 101', 'Communication', 4, 'A communications degree is a great way to prepare yourself for a career in fields ranging from media relations and journalism to marketing, corporate communications and many more.', 'School of Journalism', 'Journalism', 'Fall 2022',120, 25, 0, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(414546185, 'CS 5200', 'Data Mining', 4, 'In this course, students will learn basic concepts and tools for data mining, including data sources, data cleaning tools and methods, mainstream algorithms for data mining, statistical modeling, popular tools for mining structured data and unstructured data.','Khoury College of Computer Sciences', 'Computer Science', 'Fall 2022', 50, 20, 50, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(312442185, 'AR 5200', 'Architectural Visualization', 4, 'This course teaches what architectural visualization is, how it can give new ideas for constructing and marketing designs and buildings, and benefits companies.','College of Arts, Media and Design', 'School of Architecture', 'Fall 2022', 40, 15, 40, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(100000002, 'EN 101', 'Intro to Entrepreneurship', 4, 'Intro to technical entrepreneurship.', 'DAmore-McKim School of Business', 'School of Technological Entrepreneurship', 'Fall 2023', 40, 20, 0, 0);
-- INSERT INTO Courses (CRN, course_id, course_name, credits, course_description, college, department, semester, course_capacity, waitlist_capacity, num_students_enrolled, num_students_waitlisted) VALUES(100000001, 'EE 102', 'Foundation of Engineering', 4, 'Intro to Engineering', 'College of Engineering', 'Department of Electrical and Computer Engineering', 'Fall 2023', 50, 10, 0, 0);
